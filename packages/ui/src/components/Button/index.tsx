...
export const ButtonWrapper: React.FC<ButtonWrapperProps> = ({
  ...
  return (
    <Comp
      className={cn(
        variant === 'primary' && 'venus-primary-action',
      ...
      data-venus-button-material={material}
      data-venus-button-size={size}
      data-venus-button-variant={variant}
      data-venus-button-active={active || undefined}
      type={type}
      {...otherProps}
    >
      <ButtonOutline />
...
export const Button = ({
  ...
  >
    {loading && (
      <div className="venus-button-spinner mr-2" role="status" aria-label="Loading">
