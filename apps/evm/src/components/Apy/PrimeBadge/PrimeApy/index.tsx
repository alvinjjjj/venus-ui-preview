...
export const PrimeApy: React.FC<PrimeApyProps> = ({ apyPercentage, className, ...otherProps }) => {
  ...
  return (
    ...
    >
      ...
      <span data-apy-badge-text="prime" className="bg-[linear-gradient(26deg,#674031_-49.72%,#FFECE3_85.68%,#6D4637_221.08%,#FFECE3_383.56%)] bg-clip-text text-transparent">
        {readableApy}
      </span>
    </SenaryButton>
  );
