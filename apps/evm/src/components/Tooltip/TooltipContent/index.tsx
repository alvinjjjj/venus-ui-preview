...
>(({ className, sideOffset = 4, ...props }, ref) => (
  <Portal>
    <Content
      ...
      className={cn(
        'venus-tooltip-content flex z-50 overflow-hidden rounded-xl bg-background-hover p-2 max-w-75 text-sm text-primary-foreground animate-in fade-in-0 zoom-in-95',
