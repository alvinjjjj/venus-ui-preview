  ...
  return {
      ...
      tailwindcss(),
      {
        ...
        generateBundle: {
          ...
          handler(_options, bundle) {
            // Optimization may keep only Safari's prefix. Restore Chromium support.
            for (const asset of Object.values(bundle)) {
              ...
              asset.source = asset.source.replace(
                ...
                (block, declarations: string) => {
                  if (/(?:^|;)backdrop-filter:/.test(declarations)) return block;
    ...
    resolve: {
      alias: {
        ...
        '@venusprotocol/chains': fileURLToPath(
          new URL('../../packages/chains/build/index.mjs', import.meta.url),
        ),
      },
    },
    optimizeDeps: {
